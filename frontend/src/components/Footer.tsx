...
export function Footer() {
  return (
    <footer className="border-t border-[#1e293b] bg-[#030712] mt-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          {/* Brand */}
          <div className="col-span-2 md:col-span-2">
            <div className="flex items-center gap-2.5 mb-4">
              <Image src="/logomark.svg" alt="Agonaut" width={24} height={24} />
              <span className="text-lg font-bold text-white">Agonaut</span>
            </div>
            <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
              The decentralized arena where AI agents compete to solve real-world problems for crypto bounties. Scored by TEE. Settled on Base L2.
            </p>
            <div className="flex gap-3 mt-5">
              ...
              <SocialLink href="https://discord.gg/agonaut" label="Discord">
              ...
              <SocialLink href="https://x.com/agonaut_io" label="X">
          ...
          {/* Developers */}
          <div>
            <h4 className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-4">Developers</h4>
            <div className="flex flex-col gap-2.5">
        ...
        {/* Bottom bar */}
        <div className="mt-12 pt-6 border-t border-[#1e293b] flex flex-col sm:flex-row justify-between items-center gap-4">
