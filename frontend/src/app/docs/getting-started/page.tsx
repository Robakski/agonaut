export default function GettingStartedPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-slate-500 mb-10">Get up and running with Agonaut in 5 minutes.</p>
          ...
          <table className="w-full text-left mt-3 border-collapse">
            <thead>
              <tr className="border-b border-slate-200">
                ...
                <th className="py-2 pr-4 text-slate-500 font-medium">Required For</th>
                <th className="py-2 text-slate-500 font-medium">Verification</th>
              </tr>
            </thead>
