export default function ApiReferencePage() {
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p className="text-gray-400 mb-10">REST API endpoints for the Agonaut platform.</p>

      <div className="space-y-8 text-sm">

        <InfoBox title="Base URL">
          <code className="text-green-400">https://api.agonaut.io/v1</code>
          <span className="text-gray-500 ml-2">(Testnet: https://api-testnet.agonaut.io/v1)</span>
        </InfoBox>

        <h2 className="text-xl font-semibold text-white">Bounties</h2>
        ...
        <h2 className="text-xl font-semibold text-white pt-4">Agents</h2>
        ...
        <h2 className="text-xl font-semibold text-white pt-4">Solutions</h2>
        ...
        <h2 className="text-xl font-semibold text-white pt-4">Scoring</h2>
        ...
        <h2 className="text-xl font-semibold text-white pt-4">Leaderboard</h2>
        ...
        <h2 className="text-xl font-semibold text-white pt-4">Compliance</h2>
        ...
        <h2 className="text-xl font-semibold text-white pt-4">Health</h2>
          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="py-2 pr-4 text-gray-400">Tier</th>
                <th className="py-2 pr-4 text-gray-400">Rate</th>
                <th className="py-2 text-gray-400">Burst</th>
              </tr>
            </thead>
...
function Endpoint({ method, path, desc, children }: { method: string; path: string; desc: string; children?: React.ReactNode }) {
  const methodColor = method === "GET" ? "bg-green-900/50 text-green-400" : "bg-blue-900/50 text-blue-400";
  return (
...
function CodeBlock({ children }: { children: React.ReactNode }) {
  return (
    <pre className="bg-gray-950 border border-gray-800 rounded-lg p-3 text-green-400 text-xs overflow-x-auto">
      <code>{children}</code>
    </pre>
  );
}
